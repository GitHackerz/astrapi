...
export default function PostCard({ title, author, content, createdAt, likes }) {
                ...
                <div>
                    ...
                    <div className="mt-4 flex items-center">
                        <div className="flex mr-2 text-gray-700 text-sm mr-3">
                            <svg onClick={handleLike} fill={liked ? "red" : "none"} viewBox="0 0 24 24" className="w-4 h-4 mr-1 cursor-pointer" stroke={liked ? 'none' : "currentColor"}>
